    ...
    <>
      <ul className="flex flex-wrap gap-4 py-5">
        {dishes.map((dish) => (
          <li
            key={dish.id}
            className="relative basis-[calc(33.333%-1rem)] max-w-[calc(33.333%-1rem)] h-70 rounded bg-white shadow-md overflow-hidden hover:outline-primary hover:outline-3"
          >
            <button
